                ...
                if (edname.length() == 0 || edaddress.length() == 0 || edcontact.length() == 0 || edpincode.length() == 0) {
                    ...
                    if (isValidPinCode(edpincode.getText().toString().trim())) {
                        if (isValidMobileNo(edcontact.getText().toString().trim())) {
                            ...
                            Toast.makeText(BuyMedicineBookActivity.this, "Invalid Number Input", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(BuyMedicineBookActivity.this, "Invalid Pin code", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
